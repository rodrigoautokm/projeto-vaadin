import {
  ConnectionIndicator,
  ConnectionState
} from "./chunk-XGGXVRX6.js";
import "./chunk-P2XPD6QQ.js";
...
var Flow = class {
  ...
  async flowInit(serverSideRouting = false) {
    if (!this.isFlowClientLoaded()) {
      ...
      const bootstrapMod = await import("./FlowBootstrap-WMSV5PG6.js");
      await bootstrapMod.init(this.response);
      if (typeof this.config.imports === "function") {
        this.injectAppIdScript(appId);
        await this.config.imports();
      }
      const clientMod = await import("./FlowClient-YN6KRLRR.js");
